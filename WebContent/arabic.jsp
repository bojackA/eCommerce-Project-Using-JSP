...
<body id="page-top">
	<!-- Navigation-->
	<div class="header">
  <a   href="#default" class="logo">مختبر </a>
  <div class="header-right">
    <a class="active" href="login.jsp"></a>
    <a href="#contact">Contact</a>
    <a href="#about">About</a>
     <a href="index.jsp">عربي</a>
  </div>
</div>
	<style>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Amer's Lab</h1>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form method="post" action="contact" id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<!-- Phone number input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="phone" name="pnum" type="tel"
						...
						<!-- Message input-->
						<div class="form-floating mb-3">
							<textarea class="form-control" id="message" name="msg" type="text"
						...
						<!-- Submit Button-->
						<button class="btn btn-primary btn-xl disabled" id="submitButton" name="submitButton"
