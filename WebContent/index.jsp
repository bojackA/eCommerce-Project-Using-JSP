...
<body id="page-top">
	<!-- Navigation-->
	<div class="header">
  <a href="#default" class="logo">Amer's Lab</a>
  <div class="header-right">
    <a class="active" href="login.jsp">Login</a>
    <a href="#contact">Contact</a>
    <a href="#about">About</a>
     <a href="arabic.jsp">AR/EN</a>
  </div>
</div>
	<style>
...
@media screen and (max-width: 500px) {
  ...
  .header-right {
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Amer's Lab is an online lab created by Amer Sawan
						It's a platform where you can .</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">You can view our services, contact us, and add your email
    ...
    <form id="fcf-form-id" class="fcf-form-class" method="post" action="Contacts">
        
        <div class="fcf-form-group">
            <label for="Name" class="fcf-label">Your name</label>
            <div class="fcf-input-group">
                <input type="text" id="Name" name="fullname" class="fcf-form-control" required>
            </div>
        </div>
        ...
        <div class="fcf-form-group">
         ...
         <div class="fcf-form-group">
            <label for="phonenumber" class="fcf-label">Your Phone number</label>
            <div class="fcf-input-group">
